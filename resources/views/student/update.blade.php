...
@section('content')
    ...
    <table class="table table-striped">
        <thead><tr class="active"><td colspan="5">修改学生</td></tr></thead>
        <thead>
        <tr>
            <td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control"
                                   ...
                                   id="inputEmail3"  name="Student[name]" placeholder="请输入学生姓名">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control"
                                   ...
                                   name="Student[age]" id="inputPassword3" placeholder="请输入年龄">
                        </div>
                        <div class="col-sm-5">
                        ...
                        <div class="col-sm-5">
                            <label class="radio-inline">
                                <input type="radio" name="Student[sex]"
                                       checked="checked"
                                       {{ $student->sex == 1 ? 'checked' : ''}}
                                       id="inlineRadio1" value="1"> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="Student[sex]"
                                       {{ $student->sex == 2 ? 'checked' : ''}}
                                       id="inlineRadio2" value="2"> 女
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
